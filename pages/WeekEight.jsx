...
import p8 from '../components/wn1.png';


import { Menu } from "../App.js";


const driveEmbedUrl = "https://drive.google.com/file/d/1TqLazqlnsleGx1FKRLoKCVfchwcxfoYx/preview";

export default function WeekEight({ setCurrentPage }) {
    const leftImages = [p1,null, p2,null, p3, p7 ];
    const rightImages = [ p4, p5,p6, p8];
