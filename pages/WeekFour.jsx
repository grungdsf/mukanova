...
import p1 from '../components/we1.png';
import p2 from '../components/we2.png';
import p3 from '../components/we3.png';
import p4 from '../components/we4.png';
import p5 from '../components/we5.png';
import p6 from '../components/we6.png';
import p7 from '../components/we7.jpg';



import { Menu } from "../App.js";

const driveEmbedUrl = "https://drive.google.com/file/d/1H4gyYNtrQJpOq1ygpml-TJKawLbWw3OA/preview";


export default function WeekSix({ setCurrentPage }) {
    const leftImages = [p1,null, p2,null, p3];
    const rightImages = [ p4, p5,p6, p7];
