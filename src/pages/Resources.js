...
import photo1 from '../components/ar1.png';
import photo2 from '../components/ar2.png';

import { Menu } from "../App.js";

export default function Resources({ setCurrentPage }) {
    const leftImages = [photo2];
    const rightImages = [photo1 ];

    // 3 ссылки на Google документы и файлы
    const documents = [
        {
            url: "https://drive.google.com/file/d/17qwLOODNLJPnO6wiRfYOz1j8LZz_vaib/preview"
        }
    ];
