...
import p3 from '../components/w911.png';
import p4 from '../components/w921.png';
import p5 from '../components/w931.png';
...
const documents = [
    {
        url: "https://drive.google.com/file/d/12zFtUCR9pb2Ds7onrOh9fQYPVYwoo9Vv/preview"
    },
    {
        url: "https://docs.google.com/document/d/1f771GRik4fN8DJDEJiBumTD0DBNrnjifnhUHqDoQHXc/preview"
    }
];

export default function WeekEight({ setCurrentPage }) {
    const leftImages = [p1,null,p3,null];
    const rightImages = [ p2, p4, p5];
