...
import Assignment05 from "./pages/Assignment05";
import Assignment07 from "./pages/Assignment07";
import Assignment09 from "./pages/Assignment09";
...
export default function App() {
    ...
    if (currentPage === 'assignment03')
        return <Assignment03 setCurrentPage={setCurrentPage} />;
    if (currentPage === 'assignment05')
        return <Assignment05 setCurrentPage={setCurrentPage} />;
    if (currentPage === 'assignment07')
        return <Assignment07 setCurrentPage={setCurrentPage} />;
    if (currentPage === 'assignment09')
        return <Assignment09 setCurrentPage={setCurrentPage} />;
    if (currentPage === 'assignment10')
        return <Assignment10 setCurrentPage={setCurrentPage} />;
